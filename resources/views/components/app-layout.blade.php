            ...
            <nav class="flex-1 px-4 space-y-1 overflow-y-auto">
                @if(session('active_role') === 'admin')
                    ...
                    @if(Auth::user()->is_active)
                        ...
                        <a href="{{ route('admin.users.index') }}" class="flex items-center px-2 py-3 text-sm font-medium {{ request()->routeIs('admin.users.*') ? 'text-gray-800 bg-white shadow-sm font-semibold' : 'text-gray-400 hover:text-gray-600 hover:bg-gray-50' }} rounded-md">
                            <svg class="w-5 h-5 mr-3 {{ request()->routeIs('admin.users.*') ? 'text-gray-500' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                            Pengguna
                        </a>
