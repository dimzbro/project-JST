                    ...
                    <div style="display: flex; align-items: center;">
                        ...
                        <div>
                            ...
                            <div style="display: flex; align-items: center; margin-top: 2px; font-size: 12px;" class="text-gray-500">
                                ...
                                @if($project->client && $project->client->rating_count > 0)
                                    <span class="font-medium text-gray-700">{{ $project->client->average_rating }}</span><span class="text-gray-400">/10.0</span>
                                @else
